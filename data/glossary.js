...
var hannibal = {
    ...
    citation: "- Livy, 21.44",
    short: "Going on military campaign with his father at the age of nine, Hannibal spent nearly his entire life at war. He grew up to be one of the most celebrated tacticians in history. His tactics, which rely heavily on surprise and deception, are still taught in military academies.",
    long: "Hannibal sacked the city of Saguntum which prompted the war to begin. Once war had been declared, he personally led the invasion of Italy. He fought in Italy for fifteen years without ever losing a major battle. After Scipio’s invasion of North Africa in 205 BCE, Hannibal was recalled to defend Carthage. At the battle of Zama, Hannibal lost a decisive battle to Scipio. After the war, he was a crucial part of Carthage’s efforts to recover. When the Romans asked Carthage to hand over Hannibal to them, Hannibal went into voluntary exile. He spent about a decade serving several Eastern Mediterranean leaders. When one king tried to hand him to the Romans, Hannibal killed himself.",
...
var scipioAfricanus = {
    ...
    citation: "- Livy, 22",
    short: "Scipio Africanus was a young and charming Roman Nobleman. He was a low-level officer at Ticinus, the very first battle of the war. He would also be present at the very last battle of the war. This time, however, he would be commanding Rome’s forces. Known for his bravery and patriotism, Scipio's cunning tactics turned the tide of the war against the Carthaginians. He ultimately won the war on the plains of Zama.",
    long: "Scipio was also present at the battle of Cannae. Immediately after the battle, several officers discussed abandoning Rome and escaping to the East. Scipio found this horrendously offensive. He drew his sword and threatened these men with death if they continued to discuss abandoning the fatherland. Years later, Scipio volunteered to take over command in Spain. The Senate granted him the position despite his youth because no one else had volunteered. When Scipio arrived in Spain Rome was at a serious disadvantage. Through a series of clever ploys and tactics, Scipio managed to crush Carthaginian holdings in Spain. In addition, he secured an alliance with the Numidian prince Massinissa. With the fame from these victories he won a consulship and invaded Africa. After defeating king Syphax, he won the battle of Zama and with it the war. ",
...
var hamilcar = {
    ...
    short: "Hamilcar was one of Carthage’s most adept generals during the First Punic War. He fought a long guerilla campaign in Sicily before Carthage finally surrendered. Afterwards, he won a bitter war with rebellious mercenaries and went on to conquer most of Spain. While he fought under the name of Carthage, Hamilcar made sure that the Spanish were loyal to his family above all others.",
...
var hasdrubal = {
    ...
    short: "When Hannibal left for his invasion of Italy, Hasdrubal remained in Spain. In 215 BCE, he attempted to bring a new army to reinforce his brother in Italy. On his way, he was met by a Roman army led by two Scipio brothers. Hasdrubal tried to employ the double envelopment tactic that Hannibal had used to win the battle of Cannae. However, the attempt backfired and Hasdrubal lost the battle. After years of losing ground  in Spain to these same Scipio brothers, Hasdrubal turned the tide. He bribed their Spanish allies into deserting and defeated the Roman armies, killing both brothers. In 207 BCE, Hasdrubal again tried to lead an army into Italy to assist his brother. However, he lost the battle and died at the battle of Metaurus in Northern Italy.",
    long: "",
    anecdote: "Hasdrubal was an incredibly common name for the Carthaginians and there were several other commanders named Hasdrubal in the same war. ",
    description: "Going on military campaign with his father at the age of nine, Hannibal spent nearly his entire life at war. He grew up to be one of the most celebrated tacticians in history. His tactics, which rely heavily on surprise and deception, are still taught in military academies.",
    reference: "Oxford Classical Dictionary Entry",
...
var syphax = {
    ...
    short: `Syphax was a Numidian king who at first supported the Romans but then switched his loyalty to Carthage. Syphax was ultimately defeated and taken prisoner by his rival, Numidian prince Masinissa.`,
    long: "",
