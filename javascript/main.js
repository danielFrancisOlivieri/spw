...
function setModal(glossaryEntryObject) {
  ...
  $( ".modalDescription" ).text(glossaryEntryObject.description);
...
window.onload = function() {
    ...
    var vizjson = 'https://olivierid.carto.com/api/v2/viz/7e00627d-d06d-4e2f-b50c-a5fa23c4c6c7/viz.json';
...
function next() {
    ...
    map_object.openPopup("<h3><center>" + title + "</center></h3>" + year + " BCE - " + text, latlng, popupOptions);
